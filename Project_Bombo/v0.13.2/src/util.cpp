...
bool deleteWarning()
{
    cout << "Warning: Use of delete functions (DeleteFile, DeleteFunction, DeleteClass, etc.) can lead to unexpected behavior " << endl 
         << "if objects of the same name and type exist in your project." << endl
         << "Bombo does not track object locations within classes or objects you created manually. " << endl 
         << "Ensure unique names for standalone and class objects to avoid unintended deletions." << endl
         << "Please review your project structure and keep backups before proceeding." << endl;
    string inputString;
    cout << "Do you wish to proceed?('y' or 'yes', anything else for no): ";
...
void throwObjectDoesntExistError(string object) {cerr << "Error: " << object << " doesn't exist." << endl;} // replaces old doesnt exist errors

// void throwFunctionDoesntExistError() {cerr << "Error: Function doesn't exist." << endl;}

// void throwFileDoesntExistError() {cerr << "Error: File doesn't exist." << endl;}

void throwObjectAlreadyExistsError(string object) {cerr << "Error: " << object << " already exists." << endl;} // replaces old already exists errors
...
void throwCantOpenObjectError(string object) {cerr << "Error: Cant open " << object << "." << endl;} // replaces old cant open errors
