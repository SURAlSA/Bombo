...
void handleCommand(string& command) 
{
    ...
    unordered_map<string, function<void()>> commandMap = 
    {
        ...
        {"deleteFunction()", [&]() { if (projectLoaded) ProjectManager.deleteFunction();}},
        {"deleteClass()", [&]() { if (projectLoaded) ProjectManager.deleteClass();}},
        {"deleteStruct()", [&]() { if (projectLoaded) ProjectManager.deleteStruct();}},
        {"deleteVariable()", [&]() { if (projectLoaded) ProjectManager.deleteVariable();}},
        {"deleteUser()", [&]() { if (projectLoaded) UserManager.deleteUser();}},
        {"removeLibrary()", [&]() { if (projectLoaded) ProjectManager.removeLibrary();}},
        {"setWorkEnvironment()", [&]() {if (projectLoaded) ProjectManager.setWorkEnvironment(); }},
        {"logComment()", [&]() {if (projectLoaded) ProjectManager.logComment();}},
        {"mergeProjects()", [&]() { if (projectLoaded) ProjectManager.mergeProjects();}},
        {"enablePermissions()", [&]() { if (projectLoaded) UserManager.enablePermissions();}},
    };
